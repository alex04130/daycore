// Daycore v2 — Materials page (imports, assignments, courses) + Rules subpage + rule editor
(function () {
  'use strict';
  ...
  function MaterialsPage({ nav }) {
    ...
    const fmtTime = (isoStr) => { const d = new Date(isoStr); return window.I18N.fmtDayLabel(S.todayIso().slice(0, 10) && isoStr.slice(0, 10), S.todayIso()) + ' ' + window.I18N.fmtTime(d); };
  ...
  window.DcPages = Object.assign(window.DcPages || {}, { MaterialsPage, RuleEditor, ruleDesc });
})();

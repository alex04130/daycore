// Daycore v2 — Settings page: assistant, language, Theme Studio (custom + AI), data, about + Auth sheet
(function () {
  'use strict';
  ...
  function SettingsPage({ nav }) {
    ...
    return (
      <div className="dc-page-enter" data-screen-label="设置">
        ...
        <p className="dc-field-sub" style={{ textAlign: 'center', padding: '8px 0 20px' }}>{t('st_about_line')}</p>
      </div>
    );
  }

  window.DcPages = Object.assign(window.DcPages || {}, { SettingsPage, AccountSheet, AuthSheet });
})();
